...
def test_quickjs_hello_world():
    ...
    assert wasm_path.exists(), f"QuickJS binary not found at {wasm_path}. Run scripts/fetch_quickjs.ps1 first."
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "Hello from QuickJS-NG!" in stdout, f"Expected 'Hello from QuickJS-NG!' in stdout, got: {stdout}"
